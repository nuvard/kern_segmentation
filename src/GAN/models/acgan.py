...
os.makedirs("images/uf", exist_ok=True)
os.makedirs("images/dc", exist_ok=True)
...
transforms = aug(p=0.5, image_size=opt.img_size)
dataloader, _ = prepare_dataset('/project/data/data_uf.csv', '/project/data/data_dc.csv', '/project/data/', transforms, image_size=opt.img_size, batch_size=opt.batch_size, num_workers=8, train_prop=0.99)
...
for epoch in range(opt.n_epochs):
    for i, batch_data  in enumerate(dataloader):
        imgs, labels = batch_data.images.cuda(), batch_data.labels.cuda()
